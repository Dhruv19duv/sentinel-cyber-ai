# =============================================================================
# Sentinel Cyber AI — VPC Module
# Creates VPC with public/private subnets, NAT Gateway, security groups
# Budget: NAT Gateway ~$32/mo, rest is free
# =============================================================================
...
resource "aws_subnet" "public" {
  ...
  tags = {
    ...
    "kubernetes.io/cluster/sentinel"  = "shared"
  }
}
...
resource "aws_security_group" "ec2" {
  ...
  description = "Security group for Sentinel EC2 instance"
  vpc_id      = aws_vpc.main.id
  ...
  # Grafana (optional, direct access)
  ingress {
